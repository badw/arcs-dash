...
def start_dash(
    ...
    loading_spinner = dcc.Loading(
        html.Div(id="loading-output-1"), id="loading-1", type="circle"
    )
        ...
        dbc.Accordion(
            ...
            children=[
                ...
                dbc.AccordionItem(
                    ...
                    children=[
                        html.P([
                            "The maximum number of steps is the upper limit for how far down a reaction network a single sampling event goes.",
                            html.Br(),
                            "Default = 5",
                            html.Br(),
                        ]),
    ...
    results_concentration_bar_chart = (
    ...
    def apprun(btn1):
        ...
        if "submit-val" == ctx.triggered_id:
            ...
            default_concentrations = GenerateInitialConcentrations(
                graph=graph
            ).update_ic(update_dict=default_concentrations, include_co2=True)
            ...
            formatted_stats_table = format_statistics_table_for_dash(
                reaction_statistics
            )
            ...
            formatted_average_table = format_concentrations_table_for_dash(
